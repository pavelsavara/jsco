...
import { JsImports, ComponentFactoryInput, ComponentFactoryOptions, JsExports, JsInterfaceCollection, ComponentFactory } from './types';
...
export function createComponentFactory<TJSExports extends JsInterfaceCollection>(witModel: WITModel): ComponentFactory<TJSExports> {
