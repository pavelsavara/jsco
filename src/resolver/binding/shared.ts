...
_i32[0] = 0x7fc00000;
// typed arrays of length >= 1 always have index 0; safe to assert
export const canonicalNaN32: number = _f32[0] as number;
_i64[0] = 0x7ff8000000000000n;
export const canonicalNaN64: number = _f64[0] as number;
