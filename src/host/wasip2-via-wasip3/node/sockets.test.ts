 ...
 *
 * NOTE: These tests currently import directly from the P2 socket implementation.
 * When the P2-via-P3 socket adapter gets P2 wrapper classes (like P2DescriptorAdapter
 * for filesystem), the imports should be switched to the adapter chain.
 */
...
describe('wasi:sockets/network (P2-via-P3)', () => {
...
describe('wasi:sockets/tcp (P2-via-P3)', () => {
...
describe('wasi:sockets/udp (P2-via-P3)', () => {
...
describe('wasi:sockets/ip-name-lookup (P2-via-P3)', () => {
