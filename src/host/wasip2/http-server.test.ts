...
describe('wasi:http/types outgoing-response', () => {
...
describe('wasi:http/types response-outparam.set', () => {
...
describe('wasi:http/types future-trailers', () => {
...
describe('wasi:http/incoming-handler server', () => {
