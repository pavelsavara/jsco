...
- **Always add the license banner** as the very first line of every new `.ts`, `.js`, or `.mjs` file: `// Copyright (c) 2023 Pavel Savara. Licensed under the Apache-2.0 license with LLVM exception. See LICENSE for details.` followed by a blank line before any imports or code.
