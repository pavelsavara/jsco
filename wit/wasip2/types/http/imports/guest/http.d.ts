...
declare module 'wasi:http/imports@0.2.11' {
  ...
  export type * as WasiHttpOutgoingHandler0211 from 'wasi:http/outgoing-handler@0.2.11'; // import wasi:http/outgoing-handler@0.2.11
  export type * as WasiHttpTypes0211 from 'wasi:http/types@0.2.11'; // import wasi:http/types@0.2.11
