/// <reference path="./wasi-sockets-types.d.ts" />
declare module 'wasi:sockets/ip-name-lookup@0.3.0-rc-2026-03-15' {
  /**
  ...
  export type IpAddress = import('wasi:sockets/types@0.3.0-rc-2026-03-15').IpAddress;
  /**
   * Lookup error codes.
   */
