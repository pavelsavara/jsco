...
/// <reference path="./interfaces/wasi-http-client.d.ts" />
/// <reference path="./interfaces/wasi-http-handler.d.ts" />
...
declare module 'wasi:http/service@0.3.0-rc-2026-03-15' {
  ...
  export type * as WasiHttpClient030Rc20260315 from 'wasi:http/client@0.3.0-rc-2026-03-15'; // import wasi:http/client@0.3.0-rc-2026-03-15
  export type * as WasiHttpTypes030Rc20260315 from 'wasi:http/types@0.3.0-rc-2026-03-15'; // import wasi:http/types@0.3.0-rc-2026-03-15
  ...
  export * as handler from 'wasi:http/handler@0.3.0-rc-2026-03-15'; // export wasi:http/handler@0.3.0-rc-2026-03-15
}
