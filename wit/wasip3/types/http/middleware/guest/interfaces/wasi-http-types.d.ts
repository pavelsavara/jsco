/// <reference path="./wasi-clocks-types.d.ts" />
declare module 'wasi:http/types@0.3.0-rc-2026-03-15' {
  export type Duration = import('wasi:clocks/types@0.3.0-rc-2026-03-15').Duration;
  /**
  ...
  export class Request implements Disposable {
    ...
    */
    static 'new'(headers: Headers, contents: WasiStreamReadable<Uint8Array> | undefined, trailers: WasiFuture<Result<Trailers | undefined, ErrorCode>>, options: RequestOptions | undefined): [Request, WasiFuture<Result<void, ErrorCode>>];
    /**
    ...
    */
    static consumeBody(this_: Request, res: WasiFuture<Result<void, ErrorCode>>): [WasiStreamWritable<Uint8Array>, WasiFuture<Result<Trailers | undefined, ErrorCode>>];
    [Symbol.dispose](): void;
  }
  ...
  export class Response implements Disposable {
    ...
    */
    static 'new'(headers: Headers, contents: WasiStreamReadable<Uint8Array> | undefined, trailers: WasiFuture<Result<Trailers | undefined, ErrorCode>>): [Response, WasiFuture<Result<void, ErrorCode>>];
    /**
    ...
    */
    static consumeBody(this_: Response, res: WasiFuture<Result<void, ErrorCode>>): [WasiStreamWritable<Uint8Array>, WasiFuture<Result<Trailers | undefined, ErrorCode>>];
    [Symbol.dispose](): void;
  }
}
